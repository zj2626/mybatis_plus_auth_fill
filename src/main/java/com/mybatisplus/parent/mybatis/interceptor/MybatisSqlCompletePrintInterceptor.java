 ...
 *
 * @see: https://github.com/WangJi92/mybatis-sql-log
 */
...
public class MybatisSqlCompletePrintInterceptor implements Interceptor, Ordered {
    ...
    private Logger log = LoggerFactory.getLogger(MybatisSqlCompletePrintInterceptor.class);
    ...
    public Object intercept(Invocation invocation) throws Throwable {
        ...
        try {
            ...
            try {
                ...
                log.debug("====> {} ; -- 执行耗时: [{}]", sql, sqlCost);
            } catch (Exception e) {
                log.error("sql拦截器发生异常: {}", e.getMessage(), e);
            }
        }
    }
